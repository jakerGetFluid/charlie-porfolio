...
<article id="post-<?php the_ID(); ?>" <?php (is_single()) ? post_class() : post_class('post-item'); ?>>
    ...
    $rit_thumb= wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID()), 'full' )[0];
    ?>
    <div class="cover-post-image" data-parallax="scroll" data-image-src="<?php echo esc_url($rit_thumb);?>">
        <?php endif; ?>
