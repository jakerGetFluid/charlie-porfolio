    ...
    class RIT_Customize_Import_Export
    {
        ...
        public function _do_import($file = null){
            ...
            if ('array' != gettype($data)) {
                $cei_error = esc_html__('Error importing settings! Please check that you uploaded a customizer export file.', 'rit-core-language');
                return;
            }
            ...
            if ($data['template'] != $template) {
                $cei_error = esc_html__('Error importing settings! The settings you uploaded are not for the current theme.', 'rit-core-language');
                return;
            }
