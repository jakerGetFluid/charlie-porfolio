...
if (!class_exists('RIT_Custom_Post_Type_Portfolio')) {
    class RIT_Custom_Post_Type_Portfolio
    {
        ...
        public function get_portfolio_setting(){
            global $rit_options;
        ...
        public function register_portfolio()
        {
            ...
            $args = array(
                ...
                'hierarchical' => false,
                'rewrite' => array(
                    'slug' => _x($rit_options['portfolio-slug'], 'URL slug', 'portfolio')
                ),
                'supports' => array(
                    'title',
                    'editor',
        ...
        public function register_portfolio_category()
        {
            ...
            $args = array(
                ...
                'rewrite' => array(
                    'slug' => _x($rit_options['portfolio-categories-slug'], 'URL slug', 'portfolio_category'),
                    'with_front' => false,
                    'hierarchical' => true,
                ),
                'has_archive' => true,
