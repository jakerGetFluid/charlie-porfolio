    ...
    class RITDribbble extends WP_Widget
    {
        function __construct()
        {
            $widget_ops = array(
                ...
                'description' => esc_html__('Images from your dribbble account.', 'rit-core-language')
            );
        ...
        function form($instance)
        {
            ...
            ?>
            <p><label
                    for="<?php echo esc_attr($this->get_field_id('dribbble_title')); ?>"><?php esc_html_e('Title:', 'rit-core-language'); ?></label>
            ...
            <p><label
                    for="<?php echo esc_attr($this->get_field_id('dribbble_userid')); ?>"><?php esc_html_e('dribbble user ID:', 'rit-core-language'); ?></label>
                <br>
                ...
                <small><em>Find ID <a href="<?php echo esc_url(esc_html__('http://dribbble.com/', 'rit-core-language')); ?>"
                                      target="_blank"><?php esc_html_e('http://dribbble.com/', 'rit-core-language'); ?></a></em>
                </small>
            </p>

            <p><label
                    for="<?php echo esc_attr($this->get_field_id('dribbble_num')); ?>"><?php esc_html_e('How many dribbble display:', 'rit-core-language'); ?></label>
        ...
        function widget($args, $instance)
        {
            ...
            if ($shots) {
                ...
                echo esc_html__('Error', 'rit-core-language');
            }
            echo '</div>';
