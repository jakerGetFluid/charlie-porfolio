...
class RITTab extends WP_Widget {
    ...
    public function __construct($id_base = false, $name = '', $widget_options = array(), $control_options = array()) {
        parent::__construct('rit_tab', esc_html__('RIT Widget Tab', 'rit-core-language'), array('description' => esc_html__('Sidebar into tabbed widget.', 'rit-core-language')));
    }
    ...
    public function widget($args, $instance) {
        ...
        <?php
            ...
            esc_html_e('Tabbed widget is not properly configured.', 'rit-core-language');
        }
        echo $after_widget;
    ...
    public function form($instance) {
        ...
        <p><label>Sidebar:</label>
            ...
            <em><?php esc_html_e('Make sure not to select Sidebar holding this widget. If you do that, Tabber will not be visible.', 'rit-core-language'); ?></em>
        </p>
        <p><label><?php esc_html_e('CSS Class:', 'rit-core-language'); ?></label>
            <input class="widefat" 
