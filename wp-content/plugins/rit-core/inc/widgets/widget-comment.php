...
class RITComment extends WP_Widget
{
    ...
    function __construct()
    {
        ...
        $widget_ops = array('classname' => 'rit_comments', 'description' => esc_html__('Widget display Recent Comments with avatar', 'rit-core-language'));
        parent::__construct('rit_comments', esc_html__('RIT - Recent Comments', 'rit-core-language'), $widget_ops);
            ...
            <ul class="latest-comment-list">
                ...
                foreach ($comments as $comment) :
                    ...
                    <li <?php echo esc_html($has_avatar); ?>>
                        ...
                        <span><?php esc_html_e('on', 'rit-core-language'); ?> <?php echo get_comment_date(rit_option('date_format'), $comment->comment_ID); ?></span>
                        <span><?php esc_html_e('in :', 'rit-core-language'); ?>
    ...
    function form($instance)
    {
        ...
        $defaults = array(
            'title' => esc_html__('Comments', 'rit-core-language'),
            'count' => '5'
        );
        $instance = wp_parse_args((array)$instance, $defaults); ?>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('title:', 'rit-core-language'); ?></label>
        ...
        <p>
            <label
                for="<?php echo esc_attr($this->get_field_id('count')); ?>"><?php esc_html_e('Number of comments', 'rit-core-language'); ?></label>
