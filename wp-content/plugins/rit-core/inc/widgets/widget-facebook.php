...
if (!class_exists('RITFacebook')) {
    class RITFacebook extends WP_Widget
    {
        ...
        {
            parent::__construct('facebook_widget', 'RIT Facebook', array('description' => esc_html__('Facebook Social widget', 'rit-core-language'),));
        }

        public function form($instance)
        {
            $title = isset($instance['title']) ? $instance['title'] : esc_html__('Facebook widget', 'rit-core-language');
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'rit-core-language'); ?></label>
            ...
            <p>
                ...
                <label
                    for="<?php echo esc_attr($this->get_field_id('url')); ?>"><?php esc_html_e('Facebook Name: ( facebook.com/ * Type into field * )', 'rit-core-language'); ?></label>
            ...
            <p>
                ...
                <label
                    for="<?php echo esc_attr($this->get_field_id('width')); ?>"><?php esc_html_e('Width(px):', 'rit-core-language'); ?></label>
            ...
            <p>
                ...
                <label
                    for="<?php echo esc_attr($this->get_field_id('color')); ?>"><?php esc_html_e('Color scheme:', 'rit-core-language'); ?></label>
            ...
            <p>
                ...
                <label
                    for="<?php echo esc_attr($this->get_field_id('stream')); ?>"><?php esc_html_e('Show stream:', 'rit-core-language'); ?></label>
            ...
            <p>
                ...
                <label
                    for="<?php echo esc_attr($this->get_field_id('faces')); ?>"><?php esc_html_e('Show faces:', 'rit-core-language'); ?></label>
            ...
            <p>
                ...
                <label
                    for="<?php echo esc_attr($this->get_field_id('header')); ?>"><?php esc_html_e('Show header:', 'rit-core-language'); ?></label>
