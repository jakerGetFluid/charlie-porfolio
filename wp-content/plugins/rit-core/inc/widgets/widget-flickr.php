...
if (!class_exists('RITFlickr')) {
    class RITFlickr extends WP_Widget
    {
        ...
        function form($instance)
        {
            ...
            ?>
            <p><label
                    for="<?php echo esc_attr($this->get_field_id('flickr_title')); ?>"><?php esc_html_e('Title:', 'rit-core-language'); ?></label>
            ...
            <p><label
                    for="<?php echo esc_attr($this->get_field_id('flickr_userid')); ?>"><?php esc_html_e('Flickr user ID:', 'rit-core-language'); ?></label>
                <br>
                ...
                <small><em>Find ID <a href="<?php echo esc_url(esc_html__('http://idgettr.com/', 'rit-core-language')); ?>"
                                      target="_blank"><?php esc_html_e('http://idgettr.com/', 'rit-core-language'); ?></a></em>
                </small>
            </p>

            <p><label
                    for="<?php echo esc_attr($this->get_field_id('flickr_num')); ?>"><?php esc_html_e('How many pictures display:', 'rit-core-language'); ?></label>
