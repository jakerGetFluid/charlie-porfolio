...
if (!class_exists('RITSocialWidget')) {
    class RITSocialWidget extends WP_Widget
    {
        ...
        {
            $widget_ops = array('classname' => 'RITSocialWidget', 'description' => esc_html__('Displays your social profile.', 'rit-core-language'));

            parent::__construct(false, esc_html__('RIT Social', 'rit-core-language'), $widget_ops);
        }
