            ...
            <article <?php post_class('rit-news-item ')?> id="post-<?php the_ID(); ?>">
                ...
                <div class="rit-news-info row">
                    <div class="alt col-md-2 col-sm-2 col-xs-4">
                        ...
                        < class="comment-count"><?php comments_number(esc_html__('0 Comment', 'rit-core-language'), esc_html__('1 Comment', 'rit-core-language'), esc_html__('% Comments', 'rit-core-language'));?></p>
                    </div>
