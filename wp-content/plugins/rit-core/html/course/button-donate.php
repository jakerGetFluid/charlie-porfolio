...
<a class="rit-donate-button" data-rel="fancybox" href="#donate-button-<?php echo get_the_ID(); ?>">
	<?php echo esc_html__('Donate', 'rit-core-language')?>
</a>
<div id="donate-button-<?php echo get_the_ID(); ?>" style="/*display: none;*/">
	<div class="rit-paypal-form-wrapper">
		<h3 class="rit-paypal-form-head"><?php echo esc_html__( 'You are donating to :', 'rit-core-language') . ' <span>' . get_the_title() . '</span>'; ?></h3>
		
		<?php
		 $payment_link = 'https://www.paypal.com/cgi-bin/webscr';
		if(get_theme_mod('rit_cause_paypal_test', 0) == 1){
		...
		<form class="rit-paypal-form" action="<?php echo $payment_link; ?>" method="post" data-ajax="<?php echo admin_url('admin-ajax.php'); ?>" >
			<div class="rit-paypal-amount-wrapper">
				<span class="rit-head"><?php echo esc_html__('How much would you like to donate?', 'rit-core-language'); ?></span>
				<?php
				...
				<input type="text" class="custom-amount" placeholder="<?php echo esc_html__('Or Your Amount', 'rit-core-language') . '(' . $currency_code . ')'; ?>" />
				<div class="clear"></div>
			</div>
			<div class="rit-paypal-fields">
				<div class=""><span class="rit-head"><?php echo esc_html__('Name *', 'rit-core-language'); ?></span>
					<input class="rit-require" type="text" name="rit-name">
				</div>
				<div class=""><span class="rit-head"><?php echo esc_html__('Last Name *', 'rit-core-language'); ?></span>
					<input class="rit-require" type="text" name="rit-last-name">
				</div>
				<div class="clear"></div>
				<div class=""><span class="rit-head"><?php echo esc_html__('Email *', 'rit-core-language'); ?></span>
					<input class="rit-require rit-email" type="text" name="rit-email">
				</div>
				<div class=""><span class="rit-head"><?php echo esc_html__('Phone', 'rit-core-language'); ?></span>
					<input type="text" name="rit-phone">
				</div>		
				<div class="clear"></div>
				<div class=""><span class="rit-head"><?php echo esc_html__('Address', 'rit-core-language'); ?></span>
					<textarea name="rit-address"></textarea>
				</div>
				<div class=""><span class="rit-head"><?php echo esc_html__('Additional Note', 'rit-core-language'); ?></span>
			...
			<?php
				...
				if(!$paypal_account ){
					...
					$paypal_account  = get_theme_mod('rit_cause_paypal_account', 'sandbox@ri-charity.com');
				}
			?>
			...
			<div class="rit-notice email-invalid" style="display: none;" ><?php echo esc_html__('Invalid Email Address ', 'rit-core-language'); ?></div>
			<div class="rit-notice require-field" style="display: none;"><?php echo esc_html__('Please fill all required fields', 'rit-core-language'); ?></div>
