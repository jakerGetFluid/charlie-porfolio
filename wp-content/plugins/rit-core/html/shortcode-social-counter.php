                ...
                switch ($social) {
                    case 'facebook':
                        ...
                        <a  class="rit-sc-facebook-icon clearfix" href="<?php echo "http://facebook.com/" . $facebook_page_id; ?>" target="_blank">
                            <div class="rit-sc-inner-block">
                                <span class="social-icon"><i class="fa fa-facebook rit-sc-facebook"></i><span class="media-name"><?php esc_html_e('Facebook', 'rit-core-language');?></span></span>
                                <span class="rit-sc-count"><?php echo esc_html($count); ?></span><span class="rit-social-counter-text"><?php esc_html_e('Fans', 'rit-core-language');?></span>
                            </div>
                        </a>
                            <?php
                            break;
                    case 'twitter':
                        ...
                        <a  class="rit-sc-twitter-icon clearfix"  href="<?php echo 'http://twitter.com/'.$params['twitter']['username'];?>" target="_blank">
                            <div class="rit-sc-inner-block">
                                ...
                                <span class="rit-sc-count"><?php echo esc_html($count); ?></span><span class="rit-social-counter-text"><?php esc_html_e('Followers', 'rit-core-language');?></span>
                            </div>
                        </a>
                        <?php
                        break;
                    ...
                    case 'instagram':
                        ...
                        <a  class="rit-sc-instagram-icon clearfix" href="<?php echo $social_url; ?>" target="_blank">
                            <div class="rit-sc-inner-block">
                                <span class="social-icon"><i class="rit-sc-instagram fa fa-instagram"></i><span class="media-name"><?php esc_html_e('Instagram', 'rit-core-language');?></span></span>
                                <span class="rit-sc-count"><?php echo esc_html($count); ?></span><span class="rit-social-counter-text"><?php esc_html_e('Followers', 'rit-core-language');?></span>
                            </div>
                        </a>
                        <?php
                    ...
                    case 'youtube':
                        ...
                        <a class="rit-sc-youtube-icon clearfix" href="<?php echo $social_url; ?>" target="_blank">
                            <div class="rit-sc-inner-block">
                                <span class="social-icon"><i class="rit-sc-youtube fa fa-youtube"></i><span class="media-name"><?php esc_html_e('Youtube', 'rit-core-language');?></span></span>
                                <span class="rit-sc-count"><?php echo esc_html($count); ?></span><span class="rit-social-counter-text"><?php esc_html_e('Subscriber', 'rit-core-language');?></span>
                            </div>
                        </a>
                        <?php
                        break;
                    case 'soundcloud':
                        ...
                        <a class="rit-sc-soundcloud-icon clearfix" href="<?php echo $social_url; ?>" target="_blank">
                            <div class="rit-sc-inner-block">
                                <span class="social-icon"><i class="rit-sc-soundcloud fa fa-soundcloud"></i><span class="media-name"><?php esc_html_e('Soundcloud', 'rit-core-language');?></span></span>
                                <span class="rit-sc-count"><?php echo esc_html($count); ?></span><span class="rit-social-counter-text"><?php esc_html_e('Followers', 'rit-core-language');?></span>
                            </div>
                        </a>
                        <?php
                    ...
                    case 'dribbble':
                        ...
                        <a class="rit-sc-dribble-icon clearfix" href="<?php echo $social_url; ?>" target="_blank">
                            <div class="rit-sc-inner-block">
                                <span class="social-icon"><i class="rit-sc-dribbble fa fa-dribbble"></i><span class="media-name"><?php esc_html_e('Dribble', 'rit-core-language');?></span></span>
                                <span class="rit-sc-count"><?php echo esc_html($count); ?></span><span class="rit-social-counter-text"><?php esc_html_e('Followers', 'rit-core-language');?></span>
                            </div>
                        </a>
                        <?php
                    ...
                    case 'posts':
                        ...
                        <a class="rit-sc-edit-icon clearfix" href="javascript:void(0);">
                            <div class="rit-sc-inner-block">
                                <span class="social-icon"><i class="rit-sc-posts fa fa-edit"></i><span class="media-name"><?php esc_html_e('Post', 'rit-core-language');?></span></span>
                                <span class="rit-sc-count"><?php echo esc_html($count); ?></span><span class="rit-social-counter-text"><?php esc_html_e('Post', 'rit-core-language');?></span>
                            </div>
                        </a>
                        <?php
                        break;
                    case 'comments':
                        ...
                        <a class="rit-sc-comment-icon clearfix" href="javascript:void(0);">
                            <div class="rit-sc-inner-block">
                                <span class="social-icon"><i class="rit-sc-comments fa fa-comments"></i><span class="media-name"><?php esc_html_e('Comment', 'rit-core-language');?></span></span>
                                <span class="rit-sc-count"><?php echo esc_html($count); ?></span><span class="rit-social-counter-text"><?php esc_html_e('Comments', 'rit-core-language');?></span>
                            </div>
                        </a>
                        <?php
                        break;
