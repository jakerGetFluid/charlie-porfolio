    ...
    $(document).ready(function () {
        ...
        if ($('.cp-wrap-thumbs')[0]) {
            $('.cp-wrap-thumbs').slick({
                ...
                focusOnSelect: true,
                infinite: false,
                prevArrow: '<span class="prev-slide cp-slider-arrow"><i class="cs-font clever-icon-preview"></i></span>',
...
(function ($) {
    $.fn.extend({
        cleverMetro: function (options) {
            ...
            if (Metro[0]) {
                // Default Values
                var metro_width, item, itemwidth, data_w, col_width;
                var defaults = {
                    item: '.portfolio-img',
                    col: '3',
                    wrap_width: 1170
                ...
                itemwidth = metro_width / options.col;
                    ...
                    if ($(window).width() > 768) {
                        item.each(function () {
                            if (!$(this).data("w")) {
                                ...
                                //     if ($(this).outerWidth(true) % itemwidth > 7) {
                                //         data_w++;
                                //     }
                                // }
