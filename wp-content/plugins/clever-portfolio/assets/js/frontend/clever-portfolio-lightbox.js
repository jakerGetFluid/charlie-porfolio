        ...
        if ($('.clever-lightbox-gallery')[0]) {
            ...
            $('.clever-lightbox-gallery a').on('click', function (e) {
                ...
                if (!$('.clever-wrap-lightbox-gallery')[0]) {
                    ...
                    if (total > 1) {
                        $('.clever-wrap-lightbox-gallery-block').prepend('<span class="clever-lb-gallery-nav clever-lb-prev-item"><i class="cs-font clever-icon-prev-arrow-1"></i> </span> <span class="clever-lb-gallery-nav clever-lb-next-item"><i class="cs-font clever-icon-next-arrow-1"></i></span>')
                    }
