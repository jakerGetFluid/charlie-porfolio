    ...
    $.fn.extend({
        cleverVideoFullscreen: function (options) {
            ...
            if(Item[0]) {
                ...
                wrap_embed.append('<div class="mask-full-screen"></div><span class="cp-volume"><i class="cs-font clever-icon-volume-on"></i> </span><span class="cp-play"><i class="fa fa-play"></i> <i class="fa fa-pause"></i></span>');
                //Resize window
...
function onPlayerReady(event) {
    ...
    jQuery('.mask-full-screen').on('click', function () {
        jQuery('.cp-play').toggleClass('active');
