jQuery(function($) {
    ...
    $(function() {
        var extraFields = $("#clever-portfolio-available-extra-fields"),
            ...
            fieldsCount = $("#clever-portfolio-available-extra-fields tr").length + 1;
        ...
        $(".clever-portfolio-remove-extra-field-btn").click(function(e) {
            e.preventDefault();
