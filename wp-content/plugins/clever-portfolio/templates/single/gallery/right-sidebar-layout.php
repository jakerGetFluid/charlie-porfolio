<?php
/**
 * The template displaying content single portfolio format Gallery with layout Right Sidebar.
 *
...
<div class="row">
    <div class="col-xs-12 col-sm-6">
        <?php
            clever_get_template_part('clever-portfolio', 'single/gallery/', 'gallery', true);
        ?>
    </div>
